...
//Would be much better to read these in dynamically. Dan, get off your ass and actually do that.
                     ...
                     error:(NSError *)error
{
    ...
    switch (reason)
    {
        ...
        {
            NSLog(@"User completed the info screens successfully");
...
-(NSDictionary *)parsedDataFromTaskResult:(ORKTaskResult *)taskResult
{
    ...
    for (ORKCollectionResult *firstLevel in firstLevelResults)
    {
        ...
        {
            NSLog(@"Processing visualConsent here");
            continue;
        ...
        {
            NSLog(@"Processing consentReview here");
            for (ORKStepResult *secondLevel in firstLevel.results)
            {
