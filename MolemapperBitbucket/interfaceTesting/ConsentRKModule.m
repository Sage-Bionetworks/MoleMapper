...
//Would be much better to read these in dynamically
...
-(void)showConsent
{
    ...
    self.consentDocument.sections = @[dataGathering,privacy,dataUse,timeCommitment,studySurvey,benefits,risks,secure,issues,recontact,withdraw];
    
    //ORKVisualConsentStep *visualConsentStep = [[ORKVisualConsentStep alloc] initWithIdentifier:@"visualConsent" document:self.consentDocument];
                     ...
                     error:(NSError *)error
{
    ...
    switch (reason)
    {
        case ORKTaskViewControllerFinishReasonCompleted:
        {
            ...
            NSLog(@"User completed the consent module successfully");
            ...
            NSLog(@"firstName: %@, lastName: %@, sharingScope: %@",parsedData[@"firstName"],parsedData[@"lastName"],parsedData[@"sharingScope"]);
